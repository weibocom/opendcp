          ...
          <div class="" role="tabpanel" data-example-id="togglable-tabs">
            <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist" style="margin-bottom: 10px;">
              <li id="tab_1" role="presentation" class="hidden">
                <a data-toggle="tab" role="tab" aria-expanded="false" onclick="list(1,'organization')">业务</a>
              </li>
              <li id="tab_2" role="presentation"  class="active">
                <a data-toggle="tab" role="tab" aria-expanded="true" onclick="list(1,'cluster')">机型模板</a>
              </li>
              <li id="tab_3" role="presentation" class="hidden">
                <a data-toggle="tab" role="tab" aria-expanded="false" onclick="getList('members','organization')">成员</a>
              </li>
            </ul>
              ...
              <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                <div class="x_panel" style="border: 0px;">
                  <div class="row" style="margin-bottom: 10px;">
                    <input type="hidden" id="tab" name="tab" value="cluster">
...
<script src="../js/for_cloud/org.js?_t=<?php echo date('U');?>"></script>
