                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist" style="margin-bottom: 10px;">
                            <li id="tab_1" role="presentation" class="active">
                                <a data-toggle="tab" role="tab" aria-expanded="true" onclick="list(1)">云账号</a>
                            </li>
                        </ul>
                                ...
                                <div class="x_panel" style="border: 0px;">
                                    ...
                                    <div class="row" style="margin-bottom: 10px;">
                                        <div class="col-md-6 ">
                                            <div class="btn-group">
                                                <div class="hidden">
                                                    <input type="hidden" id="tab" name="tab" value="accont">
                                                </div>
...
<script src="../js/for_cloud/account.js?_t=<?php echo date('U');?>"></script>
