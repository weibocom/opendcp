                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist" style="margin-bottom: 10px;">
                            <li id="tab_1" role="presentation" class="active">
                                <a data-toggle="tab" aria-expanded="true" onclick="list(1,'roleresource')">资源配置</a>
                            </li>
                            <li id="tab_2" role="presentation">
                                <a data-toggle="tab" aria-expanded="false" onclick="list(1,'role')">Role配置</a>
                            </li>
                        </ul>
                                ...
                                <div class="x_panel" style="border: 0px;">
                                    <div class="row">
                                        <div class="col-md-9 form-group">
                                                <div class="hidden">
                                                    <input type="hidden" id="tab" name="tab" value="roleresource">
                                                </div>
                                                <div class="col-md-4">
                                                    <select class="form-control" id="resourceType" onchange="list(1)">
...
<script src="../js/for_layout/role.js?_t=<?php echo date('U');?>"></script>
