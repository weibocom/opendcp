          ...
          <div class="" role="tabpanel" data-example-id="togglable-tabs">
            <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist" style="margin-bottom: 10px;">
              <li id="tab_1" role="presentation" class="active">
                <a data-toggle="tab" aria-expanded="true" onclick="list(1,'action')">命令</a>
              </li>
              <li id="tab_2" role="presentation">
                <a data-toggle="tab" aria-expanded="false" onclick="list(1,'remote_step')">命令组</a>
              </li>
            </ul>
                ...
                <div class="x_panel" style="border: 0px;">
                  <div class="row">
                    <div class="col-md-9 form-group">
                      <div class="btn-group">
                        <div class="hidden">
                          <input type="hidden" id="tab" name="tab" value="action">
                        </div>
                    ...
                    <div class="col-md-3">
                      <div class="btn-group pull-right" id="tab_toolbar">
                        <a type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal" href="edit_action.php?action=add"> 创建 <i class="fa fa-plus"></i></a>
                      </div>
                    </div>
                  </div>
...
<script src="../js/for_layout/action.js?_t=<?php echo date('U');?>"></script>
