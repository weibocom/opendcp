          ...
          <div class="" role="tabpanel" data-example-id="togglable-tabs">
            <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist" style="margin-bottom: 10px;">
              <li id="tab_1" role="presentation" class="active">
                <a data-toggle="tab" role="tab" aria-expanded="true" onclick="getList('cluster')">服务</a>
              </li>
              <li id="tab_2" role="presentation">
                <a data-toggle="tab" role="tab" aria-expanded="false" onclick="getList('service')">服务池</a>
              </li>
              <li id="tab_3" role="presentation">
                <a data-toggle="tab" role="tab" aria-expanded="false" onclick="getList('pool')">节点</a>
              </li>
            </ul>
                ...
                <div class="x_panel" style="border: 0px;">
                  <div class="row">
                    <div class="col-md-9 form-group">
                      <div class="btn-group">
                        <div class="hidden">
                          <input type="hidden" id="tab" name="tab" value="service">
                        </div>
                        <div class="col-sm-4" style="padding-left:0px;">
                          <div class="input-group">
                            <span class="input-group-addon">集群</span>
                            <select class="form-control" id="fClusterId" onchange="list(1)">
                        ...
                        <div class="col-sm-4" style="padding-left:0px;" hidden="hidden">
                          <div class="input-group">
                            ...
                            <select class="form-control" id="fService" onchange="list(1)">
                        ...
                        <div class="col-sm-4" style="padding-left:0px;" hidden="hidden">
                          <div class="input-group">
                            <span class="input-group-addon">池子</span>
                            <select class="form-control" id="fPool" onchange="list(1)">
                              <option value="">全部服务池</option>
                            </select>
                          </div>
                        </div>
                          ...
                          <div class="input-group">
                            <input type="name" id="fIdx" class="form-control" placeholder="关键字">
                                <span class="input-group-btn">
                                  <button class="btn btn-default" type="button" onclick="list(1)" disabled>Go!</button>
                                </span>
                          </div>
                        </div>
                        <div class="hidden" style="padding-left:0px;">
