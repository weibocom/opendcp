          ...
          <div class="" role="tabpanel" data-example-id="togglable-tabs">
            <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist" style="margin-bottom: 10px;">
              <li id="tab_1" role="presentation" class="active">
                <a data-toggle="tab" role="tab" aria-expanded="true" onclick="getList('region')">SLB</a>
              </li>
              <li id="tab_2" role="presentation" class="hidden">
                <a data-toggle="tab" role="tab" aria-expanded="false">Listener</a>
              </li>
              <li id="tab_3" role="presentation" class="hidden">
                <a data-toggle="tab" role="tab" aria-expanded="false">Backend</a>
              </li>
            </ul>
            <div id="myTabContent" class="tab-content">
              <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                <div class="x_panel" style="border: 0px;">
                      ...
                      <div class="btn-group">
                        ...
                        <div class="col-sm-4" style="padding-left:0px;">
                          <div class="input-group">
                            ...
                            <select class="form-control" id="fRegion" onchange="getList('slb')">
                        ...
                        <div class="col-sm-4" style="padding-left:0px;" hidden="hidden">
                          <div class="input-group">
                            <span class="input-group-addon">SLB</span>
                            <select class="form-control" id="fSlb" onchange="getInfo()">
                              <option value="">请选择</option>
                            </select>
                          </div>
                        </div>
                          ...
                          <div class="input-group">
                            <input type="name" id="fIdx" class="form-control" placeholder="关键字">
                                <span class="input-group-btn">
                                  <button class="btn btn-default" type="button" onclick="list(1)">查询</button>
                                </span>
                          </div>
                        </div>
                  ...
                  <form method="post" class="form-horizontal">
                    <div class="modal fade bs-modal-lg" id="myStepModal" role="dialog" aria-hidden="true">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="myStepModalLabel">Loading ...</h4>
                          </div>
                  ...
                  <form method="post" class="form-horizontal">
                    <div class="modal fade bs-modal-lg" id="myTableModal" role="dialog" aria-hidden="true">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title" id="myTableModalLabel">Loading ...</h4>
                          </div>
                          <div class="modal-body" style="overflow:auto;" id="myTableModalBody">
                            <table class="table table-bordered table-hover" id="modal_table">
                            ...
                            <div class="row">
                              <div class="col-md-5 col-sm-5">
                                <div class="dataTables_info" id="modal_table-pageinfo" role="status" aria-live="polite">Showing 0 to 0 of 0 entries</div>
                              </div>
                              <div class="col-md-7 col-sm-7">
                                <div class="dataTables_paginate paging_bootstrap_full_number" id="sample_1_paginate">
                                  <ul class="pagination" style="visibility: visible;margin-top: 0px;margin-bottom: 0px;" id="modal_table-paginate">
                                    <li><a href="javascript:;" onclick="getBackend(1)"><i class="fa fa-angle-left"></i></a></li>
                                    <li class="active">
                                      <a href="javascript:;" onclick="getBackend(1)">1</a>
                                    </li>
                                    <li class="next">
                                      <a href="javascript:;" title="Next" onclick="getBackend(1)"><i class="fa fa-angle-right"></i></a>
                                    </li>
                                  </ul>
                                </div>
                              </div>
                          ...
                          <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <button type="button" class="btn btn-success" id="btnCommitModal" data-dismiss="modal" onclick="addBackend()" style="margin-bottom: 5px;" disabled>提交</button>
                          </div>
                        </div>
                      </div>
                    </div>
...
<!-- validator -->
<script src="../gentelella/vendors/validator/validator.min.js"></script>
<!-- jQuery Smart Wizard -->
<script src="../gentelella/vendors/jQuery-Smart-Wizard/js/jquery.smartWizard.js?_t=<?php echo date('U');?>"></script>
...
<script src="../js/for_hubble/slb.js?_t=<?php echo date('U');?>"></script>
