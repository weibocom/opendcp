...
$myGroup=(isset($_GET['group'])&&!empty($_GET['group']))?trim($_GET['group']):'';
          ...
          <div class="" role="tabpanel" data-example-id="togglable-tabs">
            <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist" style="margin-bottom: 10px;">
              <li id="tab_1" role="presentation" class="active">
                <a data-toggle="tab" role="tab" aria-expanded="true" onclick="list(1,'main')">主配置</a>
              </li>
              <li id="tab_2" role="presentation">
                <a data-toggle="tab" role="tab" aria-expanded="false" onclick="list(1,'ver')">发布记录</a>
              </li>
            </ul>
                ...
                <div class="x_panel" style="border: 0px;">
                  <div class="row">
                    <div class="col-md-8 form-group">
                      <div class="btn-group">
                        <div class="hidden">
                          <input type="hidden" id="tab" name="tab" value="main">
                          <input type="hidden" id="fGroup" name="fGroup" value="<?php echo $myGroup;?>">
                        </div>
                    ...
                    <div class="modal fade bs-modal-lg" id="myChildModal" role="dialog" aria-hidden="true">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <button type="button" class="btn btn-success" id="btnChildCommit" data-dismiss="modal" onclick="changeOnModal()" style="margin-bottom: 5px;" disabled>提交</button>
                          </div>
                        </div>
                      </div>
                    </div>
...
<script>
  $(document).ready(function() {
    ...
    window.setTimeout(<?php echo "getList('".$myIdx."')";?>,200);
  });
  ...
  $("#myViewChildModal").on("shown.bs.modal", function(){
    $("select.form-control").select2();
  });
  $("#myViewChildModal").on("hidden.bs.modal", function() {
    $(this).removeData("bs.modal");
    $('#myViewChildModalBody').css('height','');
    $('#myViewChildModalLabel').html('Loading ...');
    $("#myViewChildModalBody").html('<p> </p>');
  });
