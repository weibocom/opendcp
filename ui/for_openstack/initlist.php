...
?>
			...
			<tr>
				...
				<td><span class="badge <?php if($oneinit['status']==10){?>bg-green<?php } elseif($oneinit['status']==11) {?>bg-red<?php } elseif($oneinit['status']==1){?>bg-yellow<?php }?>"><?=node_init::$arr_status[$oneinit['status']]?></span></td>
				<td><div class="btn-group btn-group-xs btn-group-solid"><a class="text-primary tooltips" title="查看详情" href="task_detail.php?task_id=<?=$oneinit['id']?>" target="_blank"><i class="fa fa-info"></i></a> </div></td>
			</tr>
			<?php } ?>
		    </tbody>
                  </table>
