 ...
 */
  ...
  $myTitle = $type==1 ? '初始化计算节点' : '初始化控制节点';
?>
        ...
        <div class="modal-body" style="overflow:auto;" id="myModalBody">
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="compute_ip" name="compute_ip" placeholder="节点的ip" value="<?=$ip?>">
            </div>
          </div>
	  <?php if(empty($ip)) { ?>
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="compute_password" name="compute_password" placeholder="请提供root密码">
            </div>
          </div>
	  <?php } ?>
