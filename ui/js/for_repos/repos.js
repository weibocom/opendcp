  ...
  if(data.content){
    ...
    if(data.content.length>0){
      ...
      for (var i = 0; i < data.content.length; i++) {
        ...
        btnDel += '<a class="text-danger tooltips" title="" data-toggle="modal" data-target="#myModal" onclick="twiceCheck(\'delTag\',\''+fRepos+'\',\''+v.name+'\')" data-original-title="删除"><i class="fa fa-trash-o"></i></a>';
