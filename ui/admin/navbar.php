        ...
        <div class="" style="background-color:#fff;">
          <div class="" role="tabpanel" data-example-id="togglable-tabs">
            <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist" style="margin-bottom: 10px;">
              <li role="presentation" class="active"><a data-toggle="tab" data-original-title="Home" role="tab" id="home-tab" aria-expanded="true">导航树</a>
              </li>
            </ul>
              ...
              <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                <div class="x_panel" style="border: 0px;">
                  <div class="row">
                    <div class="col-md-6 form-group">
                      <div class="btn-group">
                        <div class="input-group col-md-4">
                          <input type="name" id="filter" name="filter" class="form-control" placeholder="Search for..." value="">
                    ...
                    <div class="col-md-6">
                      <div class="btn-group pull-right">
                        <a type="button" class="btn btn-success" data-toggle="modal" data-target="#myModal" href="edit_nav.php?action=add"> 创建 <i class="fa fa-plus"></i></a>
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-success" id="btnCommit" data-dismiss="modal" onclick="change()" disabled>确认提交</button>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <form method="post" class="form-horizontal">
                    <div class="modal fade bs-modal-lg" id="myViewModal" tabindex="-1" role="dialog" aria-hidden="true">
                      <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                          <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
